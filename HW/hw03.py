...
def count_coins(change):
    ...
    def count(change, smallest_coin):
        if change == 0:
            return 1

        if smallest_coin == None or change < 0:
            return 0

        return count(change - smallest_coin, smallest_coin) + count(change, next_larger_coin(smallest_coin))

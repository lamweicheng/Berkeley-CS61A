...
def balanced(m):
    ...
    isbalanced_left = balanced(end(left_arm))
    isbalanced_right = balanced(end(right_arm))

    if left_val == right_val and isbalanced_left and isbalanced_right:
        return True
    else:
        return False
    ...
    #
    # left_val, right_val = length(left_arm) * total_weight(end(left_arm)), length(right_arm) * total_weight(end(right_arm))
    #
    # isBalanced_left, isBalanced_right = balanced(end(left_arm)), balanced(end(right_arm))
    #
    # if left_val == right_val and isBalanced_left and isBalanced_right:
    #     return True
    # else:
